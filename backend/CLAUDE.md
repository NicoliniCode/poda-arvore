...
| `ui-ux.md` | **Guia visual obrigatorio.** Design tokens, componentes, anti-padroes. |
...
6. **Em tarefas de UI: seguir `ui-ux.md` literalmente.** O guia ja define stack, tokens, componentes e anti-padroes. Se algo nao estiver coberto, escolher o que se aproximar mais do estilo Linear/Vercel/shadcn — **nunca** default de Bootstrap/Material.
...
- Qualquer alteracao visual no frontend segue `ui-ux.md`.
...
- [ ] Em tarefas de UI: checklist de `ui-ux.md` (secao "Criterios de Aceite") foi seguido?
...
- Em UI: usar Material UI, Ant Design, Bootstrap, Chakra. O sistema **e** shadcn/ui + Tailwind.
